...
public partial class WeaponPartLaser : ShipPart
{
    //non-optional stats
    ...
    [Export] public override string type { get; set; } = "WeaponPartLaser";
    ...
    [Export] public override string SpriteTexturePath { get; set; } = "res://gfx/gui/parts/weapon_laser.png";
    [Export] public override string MenuTexturePath { get; set; } = "res://gfx/gui/construction/icon/weaponry/weapon_laser.png";

    public override void changeStats(bool add)
    {
        PlayerVariables.Instance.WeaponList[4] += addOrSubtractInt(add);
    }
}
