...
public partial class WeaponPartMissile : ShipPart
{
    //non-optional stats
    ...
    [Export] public override string type { get; set; } = "WeaponPartMissile";
    ...
    [Export] public override string SpriteTexturePath { get; set; } = "res://gfx/gui/parts/weapon_missile.png";
    [Export] public override string MenuTexturePath { get; set; } = "res://gfx/gui/construction/icon/weaponry/weapon_missile.png";
