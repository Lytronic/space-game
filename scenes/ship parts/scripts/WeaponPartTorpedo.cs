...
public partial class WeaponPartTorpedo : ShipPart
{
    //non-optional stats
    ...
    [Export] public override string type { get; set; } = "WeaponPartTorpedo";
    ...
    {
        PlayerVariables.Instance.WeaponList[9] += addOrSubtractInt(add);
    }
}
