...
public partial class WeaponPartRail : ShipPart
{
    //non-optional stats
    ...
    [Export] public override string type { get; set; } = "WeaponPartRail";
    ...
    [Export] public override string SpriteTexturePath { get; set; } = "res://gfx/gui/parts/weapon_rail.png";
    [Export] public override string MenuTexturePath { get; set; } = "res://gfx/gui/construction/icon/weaponry/weapon_rail.png";
